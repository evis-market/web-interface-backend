    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_formats', models.ManyToManyField(blank=True, db_table='seller_product_data_formatsc', to='product_data_types.DataFormat', verbose_name='Content data formats')),
