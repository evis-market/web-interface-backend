...
class SellerProductsSerializer(serializers.ModelSerializer):
    ...
    seller_id = serializers.PrimaryKeyRelatedField(queryset=Seller.objects.all(), write_only=True)
    ...
    def create(self, validated_data):
        ...
        seller_product_archived = SellerProductArchive()
        seller_product_archived = copy_instance(seller_product, seller_product_archived)
